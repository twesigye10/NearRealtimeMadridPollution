...
stn_location_data = [['004', 'Plaza de España', 439577.503, 4475070.366, 637, 'Urbana de tráfico'],
...
for f_data in feilds_to_add_flist:
    create_field_from_list(empty_fc, f_data)
...
stn_with_index = madpolindexcalculation.dataIndices(pldata)
...
data_to_insert = formatted_stn_data_with_mlaqi(stn_location_data, stn_with_index)
with arcpy.da.InsertCursor(empty_fc, fields) as updLyr:
